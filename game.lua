...
function scene:create( event )
    ...
    explosionSound = audio.loadSound("assets/audio/explosion.wav")
    fireSound = audio.loadSound("assets/audio/fire.wav")
    musicTrack = audio.loadStream("assets/audio/80s-Space-Game_Looping.wav")
end
